...
;; This file bundles up some of the test related code used when
;; developing Evil proper.
    ...
    (unwind-protect
        (with-current-buffer marker-buffer
          ...
          (when evil-test-point
            (setq before-point (buffer-substring-no-properties (point-min) evil-test-point)
                  after-point (buffer-substring-no-properties evil-test-point (point-max))))
